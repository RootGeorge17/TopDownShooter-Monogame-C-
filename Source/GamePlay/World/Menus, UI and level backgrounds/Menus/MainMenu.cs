...
namespace TopDownShooter
{
    public class MainMenu
    {
        ...
        public MainMenu(PassObject PLAYCLICKDEL, PassObject EXITCLICKDEL)
        {
            ...
            buttons.Add(new Button2d("2d\\Misc\\SimpleBtn", new Vector2(0, 0), new Vector2(190, 52), new Vector2(1, 1), "Fonts\\Arial16", "New Game", PlayClickDel, 1));

            buttons.Add(new Button2d("2d\\Misc\\SimpleBtn", new Vector2(0, 0), new Vector2(190, 52), new Vector2(1, 1), "Fonts\\Arial16", "Exit", ExitClickDel, null));
        }
        ...
        public virtual void Update()
        {
            ...
            {
                buttons[i].Update(new Vector2(Globals.screenWidth / 2, 350 + 45 * i));
            }
        }
        ...
        public virtual void Draw()
        {
            ...
            for(int i=0;i<buttons.Count;i++)
            {
                buttons[i].Draw(new Vector2(Globals.screenWidth / 2, 350 + 45 * i));
            }
        }
    }
}
